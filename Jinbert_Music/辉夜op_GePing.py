...
seq_GePing += [('gei', la(5, 24), 'lao', ti(5, 12), la(5, 12), la(5, 24),
				BL(24), 'la', la(5, 24), 'mei', so(5, 24), 'sou', la(5, 24), la(5, 24))]
...
# 第19节
seq_GePing += [('la', la(5, 24), 'mei', so(5, 24), 'sou', la(5, 24),
...
# 第23节
seq_GePing += [('she', do(5, 24), 'dan', do(5, 24), BL(48),
				'bu', do(5, 24), 'jia', re(5, 24), 'la', mi(5, 24), 'ti', do(5, 24))]
...
doc.setTrackVolume(track_GePing, 0.7)
